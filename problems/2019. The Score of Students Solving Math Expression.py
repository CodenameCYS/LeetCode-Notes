...
Constraints:
    1. 3 <= s.length <= 31
    2. s represents a valid expression that contains only digits 0-9, '+', and '*' only.
    3. All the integer operands in the expression are in the inclusive range [0, 9].
    4. 1 <= The count of all operators ('+' and '*') in the math expression <= 15
    5. Test data are generated such that the correct answer of the expression is in the range of [0, 1000].
    6. n == answers.length
    7. 1 <= n <= 104
    8. 0 <= answers[i] <= 1000
'''
