...
Constraints:
    ...
    5. It is guaranteed that unit 0 can be converted into any other unit through a unique combination of conversions without using any conversions in the opposite direction.
'''
MOD = 10**9+7
# === 595ms && 78.2MB === #
class Solution:
